...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('fuel_transactions', function (Blueprint $table) {
            ...
            $table->foreign('reversed_by')->references('id')->on('fuel_transactions')->onDelete('set null');
            $table->unsignedBigInteger('reverses')->nullable();
            $table->foreign('reverses')->references('id')->on('fuel_transactions')->onDelete('set null');
        });
    }
